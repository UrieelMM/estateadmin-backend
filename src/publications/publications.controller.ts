import { Controller, Post, UseInterceptors, UploadedFiles, Req, UsePipes, ValidationPipe } from '@nestjs/common';
...
export class PublicationsController {
  ...
  async createPublication(@Req() req: Request, @UploadedFiles() files: any) {
    ...
    return await this.publicationsService.createPublication(createPublicationDto, files);
  }
}
